...
export const HERO_SLIDES_MANIFEST: Record<string, HeroSlidesConf> = {
  // key = `${room}:${collection}`
  "bedrooms:amber": { base: "/slidermenu/bedrooms/amber", count: 6, ext: "jpg" },
  "living:amber": { base: "/slidermenu/living/amber", count: 6, ext: "jpg" },

  "bedrooms:scandi": { base: "/slidermenu/bedrooms/scandi", count: 6, ext: "jpg" },
