...
export const SCANDI_PRODUCTS: CatalogProduct[] = [
  ...
  makeProduct({
   ...
   makeProduct({
    ...
    title: "Шкаф техстворчатый с угловым модулем",
    brand: "scandi",
    cat: "shkafy",
  ...
  makeProduct({
    ...
    title: "Шкаф техстворчатый зеркальный с угловым модулем",
    brand: "scandi",
    cat: "shkafy",
    basePath: "/products/scandi/shkafy/3d-mirror-combined",
    gallery: makeGallery("/products/scandi/shkafy/3d-mirror-blind-combined", 1),
    priceUZS: 0,
    priceRUB: 0,
